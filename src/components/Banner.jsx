        ...
        <>
            <div className='container mx-auto h-[87vh] flex justify-center items-center'>
                <div className='flex flex-col gap-5'>
                    <h1 className='text-transparent font-extrabold text-7xl bg-clip-text bg-gradient-to-r from-white to-slate-300 animate__animated animate__fadeInDown'>Welcome to DeviTools,</h1>
